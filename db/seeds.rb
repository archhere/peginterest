...
Peg.create(title:"Truely delicious red apples",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589916/random%20pics%20for%20dashboard/roksolana-zasiadko-29080-unsplash.jpg")
...
Peg.create(title:"We share our meals",author_id:c.id,board_id:l.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528590013/random%20pics%20for%20dashboard/david-clode-424529-unsplash.jpg")
...
Peg.create(title:"My friend fishy",author_id:c.id,board_id:l.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589995/random%20pics%20for%20dashboard/david-clode-643810-unsplash.jpg")
Peg.create(title:"I might eat him",author_id:c.id,board_id:l.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528590055/random%20pics%20for%20dashboard/craig-lovelidge-362228-unsplash.jpg")
Peg.create(title:"Moody today",author_id:c.id,board_id:l.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589958/random%20pics%20for%20dashboard/holger-link-652805-unsplash.jpg")
Peg.create(title:"These are my neighbours",author_id:c.id,board_id:l.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528590040/random%20pics%20for%20dashboard/crystal-gard-228496-unsplash.jpg")
Peg.create(title:"Migration time",author_id:c.id,board_id:l.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589802/random%20pics%20for%20dashboard/yang-miao-551683-unsplash.jpg")
Peg.create(title:"I love red color",author_id:c.id,board_id:l.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589902/random%20pics%20for%20dashboard/sergio-rola-29275-unsplash.jpg")
Peg.create(title:"I like red chillies",author_id:c.id,board_id:l.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589850/random%20pics%20for%20dashboard/thomas-foley-433567-unsplash.jpg")
Peg.create(title:"My lord created this field",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589779/random%20pics%20for%20dashboard/zbynek-burival-626154-unsplash.jpg")
Peg.create(title:"Red roses are so lovely",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589875/random%20pics%20for%20dashboard/sidney-pearce-560102-unsplash.jpg")
Peg.create(title:"We used to live here",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589930/random%20pics%20for%20dashboard/johnny-chen-77989-unsplash.jpg")
Peg.create(title:"Another one of my pets",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589941/random%20pics%20for%20dashboard/jessica-weiller-93131-unsplash.jpg")
Peg.create(title:"My garden in autumn",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528590026/random%20pics%20for%20dashboard/daniel-kim-90534-unsplash.jpg")
Peg.create(title:"I like these flowers too",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528590070/random%20pics%20for%20dashboard/anh-nguyen-436955-unsplash.jpg")
Peg.create(title:"He is my pet",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589979/random%20pics%20for%20dashboard/ganapathy-kumar-93498-unsplash.jpg")
Peg.create(title:"I grew these lovely flowers",author_id:d.id,board_id:j.id,image_url:"https://res.cloudinary.com/archhere/image/upload/v1528589832/random%20pics%20for%20dashboard/wes-hicks-403402-unsplash.jpg")
